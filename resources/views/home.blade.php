...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <div id="logo">
        <h1><a href="/">SI<span>KENI</span></a></h1>
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="#team">Sikeni Squad</a></li>
  ...
  <section id="hero">
    <div class="hero-container" data-aos="fade-in">
      <h1>Welcome to SIKENI</h1>
      <img src="assets/img/logo.png" alt="Hero Imgs" data-aos="zoom-out" data-aos-delay="100">
      <a href="/signinpetani" class="btn-get-started scrollto col-md-2">Sign In as Petani</a>
      <a href="/signinmahasiswa" class="btn-get-started scrollto">Sign In as Mahasiswa</a>
    </div>
  ...
  <main id="main">
      ...
      <div class="container" data-aos="fade-up">
        <div class="row justify-content-center">
          ...
          <div class="col-md-5 col-lg-3">
            <img src="assets/img/logo.png" alt="About" data-aos="zoom-in" data-aos-delay="100">
          </div>

          <div class="col-md-7 col-lg-5">
            <div class="about-content" data-aos="fade-left" data-aos-delay="100">

              <h2><span>SIKENI</span></h2>
              <p>SIKENI merupakan produk di segmen pasar tenaga kerja yang memberikan manfaat untuk mengurangi tingkat pengangguran bagi fresh graduate yang mengalami masalah dalam mencari pekerjaan di bidang pertanian.
                Produk kami berbeda dengan kompetitor, produk kami menghubungkan fresh graduate dengan pemilik lahan melalui informasi-informasi di bidang pertanian yang disediakan oleh sistem kami.</p>
            </div>
          </div>
    ...
    <section id="team" class="padd-section text-center">
      ...
      <div class="container" data-aos="fade-up">
        <div class="section-title text-center">
          <h2>Team Member</h2>
          <p class="separator">Membangun Pertanian Indonesia Bersama SIKENI </p>
        </div>
        
          <div class="row justify-content-center">

            <div class="col-md-6 col-md-4 col-lg-3 row g-2" data-aos="zoom-in" data-aos-delay="100">
              <div class="team-block bottom">
                <img src="assets/img/ira.png" class="img-responsive" alt="img">
            ...
            <div class="col-md-6 col-md-4 col-lg-3 row g-2" data-aos="zoom-in" data-aos-delay="200">
              <div class="team-block bottom">
                <img src="assets/img/yuda.jpg" class="img-responsive" alt="img">
                <div class="team-content">
                  <ul class="list-unstyled">
                    <li><a href="#"><i class="bi bi-facebook"></i></a></li>
                    <li><a href="#"><i class="bi bi-twitter"></i></a></li>
            ...
            <div class="col-md-6 col-md-4 col-lg-3 row g-2" data-aos="zoom-in" data-aos-delay="300">
              <div class="team-block bottom">
                <img src="assets/img/adel.png" class="img-responsive" alt="img">
                <div class="team-content">
                  <ul class="list-unstyled">
                    <li><a href="#"><i class="bi bi-facebook"></i></a></li>
                    <li><a href="#"><i class="bi bi-twitter"></i></a></li>
          ...
          <div class="row justify-content-center">
            ...
            <div class="col-md-6 col-md-4 col-lg-3 row g-2" data-aos="zoom-in" data-aos-delay="400">
              <div class="team-block bottom">
                <img src="assets/img/hilya.png" class="img-responsive" alt="img">
                <div class="team-content">
                  <ul class="list-unstyled">
                    <li><a href="#"><i class="bi bi-facebook"></i></a></li>
                    <li><a href="#"><i class="bi bi-twitter"></i></a></li>
            ...
            <div class="col-md-6 col-md-4 col-lg-3 row g-2" data-aos="zoom-in" data-aos-delay="200">
              <div class="team-block bottom">
                <img src="assets/img/silma.png" class="img-responsive" alt="img">
                <div class="team-content">
                  <ul class="list-unstyled">
                    <li><a href="#"><i class="bi bi-facebook"></i></a></li>
                    <li><a href="#"><i class="bi bi-twitter"></i></a></li>
            ...
            <div class="col-md-6 col-md-4 col-lg-3 row g-2" data-aos="zoom-in" data-aos-delay="200">
              <div class="team-block bottom">
                <img src="assets/img/zahra.png" class="img-responsive" alt="img">
                <div class="team-content">
                  <ul class="list-unstyled">
                    <li><a href="#"><i class="bi bi-facebook"></i></a></li>
                    <li><a href="#"><i class="bi bi-twitter"></i></a></li>
          ...
          <div class="col-lg-3 col-md-4">
            ...
            <div class="info">
              <div>
                ...
                <p>Jalan Veteran, Purwakarta</p>
              </div>

              <div class="email">
                <i class="bi bi-envelope"></i>
                <p>sikeni@gmail.com</p>
              </div>
  ...
  <footer class="footer">
      ...
      <div class="row justify-content-center">
        ...
        <div class="col-md-12 col-lg-4">
          <div class="footer-logo">
            ...
            <a class="navbar-brand" href="#">SIKENI</a>
            <p>SIKENI merupakan produk di segmen pasar tenaga kerja yang memberikan manfaat untuk mengurangi tingkat pengangguran bagi fresh graduate yang mengalami masalah dalam mencari pekerjaan di bidang pertanian.</p>
    ...
    <div class="copyrights">
      <div class="container">
        <p>&copy; Copyrights SIKENI. All rights reserved.</p>
        <div class="credits">
          <!--
